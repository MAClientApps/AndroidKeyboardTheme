...
import static com.cmalergun.photokeyboard.PhotoKeyBoard_ThemeActivity.THEME_KEY;
...
public class SoftKeyboard extends InputMethodService
    ...
    private PhotoCandidateView mCandidateView;
    ...
    public View onCreateCandidatesView() {
        mCandidateView = new PhotoCandidateView(this);
    ...
    public void onStartInput(EditorInfo attribute, boolean restarting) {
        ...
        if (mCurKeyboard == mPashtoLatinKeyboard || mCurKeyboard == mPashtoLatinShiftedKeyboard)
            mPredictionOn = false;
        if (mPredictionOn) db = new DBManager(this);
